...
const Home = () => {
  const Rectangle = () => {
    return (
      <>
        <div className="absolute top-[13px] left-0 w-full h-0 border-l-[50vw] border-r-[50vw] border-b-[100px] border-l-transparent border-r-transparent border-b-white dark:border-b-black"></div>
  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="hidden md:block relative w-full mt-[-1px]">
        <Rectangle />
      </div>
