...
const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <nav
      className={`relative bg-primary flex justify-between px-4 mx-auto my-[-1px] text-white sm:text-xs md:text-xs md:px-0 md:justify-around lg:text-base ${
    ...
    >
      ...
      <div className="items-center text-white font-semibold gap-5 hidden md:flex">
        ...
        <LinkButton href="/signUp" bg="white">
          {t("postTask")}
        </LinkButton>
      </div>
