...
const HeroSection = () => {
  ...
  return (
    <div
      className="bg-primary dark:bg-black pb-20 text-white text-center px-4 md:bg-[url('/Images/InitialScreen/magnet.png'),url('/Images/InitialScreen/eye.png')] md:bg-no-repeat"
      style={{
