...
const ListYourBusiness = () => {
  ...
  return (
    <div
      className="relative md:top-[-100px] w-[100%] mb-5 md:mb-0 sm:w-[80%] md:[70%] lg:w-[80%] xl:w-[60%] flex flex-col md:flex-row p-6 gap-5 md:gap-12 min-h-[300px] items-center justify-center bg-purple-600 dark:bg-primary rounded-lg"
