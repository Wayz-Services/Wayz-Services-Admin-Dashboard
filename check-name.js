...
`);
  ...
  console.log(
    `✅ Project name detected as "${packageJson.name}". Cleaning up...`,
  );
  ...
  console.log(
    `🚨 Please rename the project folder from "nextjs-setup" to your desired project name (if not done already).`,
  );
}
